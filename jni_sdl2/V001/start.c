...
#define LOG_FILE_NAME "/sdcard/libmain.log"
...
// Initialisiert die Log-Datei auf der SD-Karte
static void init_log_file() {
    if (log_file != NULL) return;
    
    // Versuche, die Datei auf der SD-Karte zu öffnen
    log_file = fopen(LOG_FILE_NAME, "a");
    if (log_file == NULL) {
        // Fallback: Interner Speicher
        log_file = fopen("/data/local/tmp/libmain.log", "a");
    }
...
// Schreibt eine Nachricht in die Log-Datei (mit Zeitstempel)
...
// ============================================================
// ★ ★ ★ ANDROID LOGCAT LOGGING (wie gehabt) ★ ★ ★
// ============================================================
...
// ============================================================
// ★ ★ ★ KOMBINIERTE LOG-FUNKTIONEN (Datei + Logcat) ★ ★ ★
// ============================================================
...
// ============================================================
// ★ ★ ★ ORIGINAL START.C CODE (unverändert) ★ ★ ★
// ============================================================
...
// ============================================================
// ★ ★ ★ ORIGINAL JNI-FUNKTIONEN (unverändert) ★ ★ ★
// ============================================================
...
static PyObject *androidembed_log(PyObject *self, PyObject *args) {
    ...
    log_to_file("PYTHON", getenv("PYTHON_NAME"), logstr);
    Py_RETURN_NONE;
}
...
#if PY_MAJOR_VERSION >= 3
static struct PyModuleDef androidembed = {Py