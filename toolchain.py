...
class ToolchainCL:
    ...
    def __init__(self):
        ...
        parser_clean.add_argument(
            ...
            help=('The build component(s) to delete. You can pass any '
                  ...
                  '"distributions", "bootstrap_builds10", "downloads".'))
    ...
    def clean_bootstrap_builds(self, _args):
        ...
        rmdir(join(self.ctx.build_dir, 'bootstrap_builds10'))
        # for bs in Bootstrap.all_bootstraps():
        #     bs = Bootstrap.get_bootstrap(bs, self.ctx)
    ...
    def _build_package(self, args, package_type):
        ...
        with current_directory(dist.dist_dir):
            ...
            if exists('/usr/bin/dos2unix'):
                ...
                # .../build/bootstrap_builds10/sdl2-python3/gradlew
    ...
    def build_status(self, _args):
        ...
        bootstrap_dir = join(self.ctx.build_dir, 'bootstrap_builds10')
